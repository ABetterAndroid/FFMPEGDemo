...
public class FFmpegCommands {
     ...
     * @return
     */
    public static String[] videoInVideo(String videoUrl, String outUrl) {
        ...
        commands[6] = "[1:v]scale=w=200:h=500:force_original_aspect_ratio=decrease[ckout];[0:v][ckout]overlay=x=W-w:y=H-h[out]";
        commands[7] = "-map";
        commands[8] = "[out]";
        commands[9] = "-movflags";
        commands[10] = "faststart";
        commands[11] = outUrl;
        return commands;
    }
    ...
    /**
     * -c:v libx264 -crf 18
     * 分屏 https://stackoverflow.com/a/42257415/6080136
     * https://stackoverflow.com/a/39220071/6080136
     * @param videoUrl
     * @param outUrl
     * @return
     */
    public static String[] splitVideo(String sourceVideolUrl, String videoUrl, String outUrl) {
        String[] commands = new String[8];
        commands[0] = "ffmpeg";
        commands[1] = "-i";
        commands[2] = sourceVideolUrl;
        commands[3] = "-i";
        commands[4] = videoUrl;
        commands[5] = "-filter_complex";
        commands[6] = "[0:v]scale=480:640,setsar=1[l];[1:v]scale=480:640,setsar=1[r];[l][r]hstack;[0][1]amix";
//        commands[6] = "hstack,format=yuv420p";
//        commands[7] = "-vsync";
//        commands[8] = "0";
//        commands[6] = "hstack,format=yuv420p";
        commands[7] = outUrl;
